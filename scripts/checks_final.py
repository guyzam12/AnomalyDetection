...
df_results = pd.read_csv("/Users/guyzamberg/PycharmProjects/git/AnomalyDiffusion/final_models/aloi_no_labels_512bit_500000steps_summary.csv")
...
for i in range(49):
    ...
    if isinstance(mse, int):
        ...
        #df_main["Dist{}nn_mse_norm".format(i)] = (mse)
...
for i in range(5):
    ...
    if isinstance(mse, int):
        ...
        #df_main["LOF{}nn_mse_norm".format(i)] = (mse)
...
for i in range(features_num):
    ...
    if isinstance(mse, int):
        ...
        #df_main["f{}_mse_norm".format(i)] = (mse)
