...
df_orig = pd.read_csv("/Users/guyzamberg/PycharmProjects/git/AnomalyDiffusion/datasets/shuttle-unsupervised-ad_train.csv", header=None)
df_results = pd.read_csv("/Users/guyzamberg/PycharmProjects/git/AnomalyDiffusion/final_models/train_test/shuttle_train_512bit_200000steps_summary.csv")
